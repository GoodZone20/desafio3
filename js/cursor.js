...
const fundo = window.document.getElementById("button")
...
function entrar(){
    ...
    if (estado == 0){
        ...
        nao.style.transform="translate(100px, -250px)"
    }
    if (estado == 1){
    ...
    if (estado == 3){
        nao.style.transform="translate(-325px, -100px)"
    }
    if (estado == 4){
        nao.style.transform="translate(+135px, +150px)"
    }
    if (estado == 5){
        nao.style.transform="translate(+105px, -150px)"
    }
    if (estado == 6){
        nao.style.transform="translate(-325px, +150px)"
    }
